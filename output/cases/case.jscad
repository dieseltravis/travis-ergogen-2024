function standoff_extrude_4_outline_fn(){
    return CAG.circle({"center":[25.5075495,-174.7153129],"radius":2.5})
.union(
    CAG.circle({"center":[317.2523457,-186.6853277],"radius":2.5})
).union(
    CAG.circle({"center":[394.4136048,-120.2239145],"radius":2.5})
).union(
    CAG.circle({"center":[401.1387339,-64.7382362],"radius":2.5})
).union(
    CAG.circle({"center":[179.4409353,-155.1036924],"radius":2.5})
).union(
    CAG.circle({"center":[147.2717316,-155.2143334],"radius":2.5})
).union(
    CAG.circle({"center":[176.782678,-98.0155484],"radius":2.5})
).union(
    CAG.circle({"center":[149.5991494,-98.1117449],"radius":2.5})
).union(
    CAG.circle({"center":[29.2428513,-65.8895431],"radius":2.5})
).extrude({ offset: [0, 0, 4] });
}


function mounting_extrude_4_outline_fn(){
    return CAG.circle({"center":[25.5075495,-174.7153129],"radius":1.5})
.union(
