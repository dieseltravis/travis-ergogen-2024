function standoff_extrude_4_outline_fn(){
    return CAG.circle({"center":[29.2192609,-199.7526231],"radius":2.5})
.union(
    CAG.circle({"center":[314.6764513,-211.9580415],"radius":2.5})
).union(
    CAG.circle({"center":[391.7401899,-145.3835758],"radius":2.5})
).union(
    CAG.circle({"center":[397.335175,-89.9384748],"radius":2.5})
).union(
    CAG.circle({"center":[175.7700971,-180.6288592],"radius":2.5})
).union(
    CAG.circle({"center":[150.5204982,-180.637497],"radius":2.5})
).union(
    CAG.circle({"center":[173.028147,-123.5446741],"radius":2.5})
).union(
    CAG.circle({"center":[153.2624482,-123.5533118],"radius":2.5})
).union(
    CAG.circle({"center":[33.2698416,-90.9381322],"radius":2.5})
).extrude({ offset: [0, 0, 4] });
}


function mounting_extrude_4_outline_fn(){
    return CAG.circle({"center":[29.2192609,-199.7526231],"radius":1.5})
.union(
