function standoff_extrude_4_outline_fn(){
    return CAG.circle({"center":[16.5081575,-174.8199255],"radius":2.5})
.union(
    CAG.circle({"center":[308.2529537,-186.7899404],"radius":2.5})
).union(
    CAG.circle({"center":[385.4142128,-120.3285272],"radius":2.5})
).union(
    CAG.circle({"center":[392.1393419,-64.8428489],"radius":2.5})
).union(
    CAG.circle({"center":[170.4415433,-155.2083051],"radius":2.5})
).union(
    CAG.circle({"center":[138.2723396,-155.3189461],"radius":2.5})
).union(
    CAG.circle({"center":[167.783286,-98.1201611],"radius":2.5})
).union(
    CAG.circle({"center":[140.5997574,-98.2163576],"radius":2.5})
).union(
    CAG.circle({"center":[20.2434593,-65.9941558],"radius":2.5})
).extrude({ offset: [0, 0, 4] });
}


function mounting_extrude_4_outline_fn(){
    return CAG.circle({"center":[16.5081575,-174.8199255],"radius":1.5})
.union(
