...
.union(
    CAG.circle({"center":[315.8885537,-188.9838196],"radius":2.5})
).union(
    CAG.circle({"center":[393.5303224,-123.084388],"radius":2.5})
).union(
    CAG.circle({"center":[400.6581284,-67.649],"radius":2.5})
).union(
