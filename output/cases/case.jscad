function standoff_extrude_4_outline_fn(){
    return CAG.circle({"center":[24.2383556,-174.8959054],"radius":2.5})
.union(
    CAG.circle({"center":[315.8311953,-189.0082407],"radius":2.5})
).union(
    CAG.circle({"center":[393.9957246,-123.8288613],"radius":2.5})
).union(
    CAG.circle({"center":[402.0528442,-69.1466653],"radius":2.5})
).union(
    CAG.circle({"center":[178.3100743,-156.4024362],"radius":2.5})
).union(
    CAG.circle({"center":[146.1409153,-156.2795096],"radius":2.5})
).union(
    CAG.circle({"center":[176.0663759,-99.2964966],"radius":2.5})
).union(
    CAG.circle({"center":[148.8828654,-99.1953244],"radius":2.5})
).union(
    CAG.circle({"center":[28.7636891,-66.1001244],"radius":2.5})
).extrude({ offset: [0, 0, 4] });
}


function mounting_extrude_4_outline_fn(){
    return CAG.circle({"center":[24.2383556,-174.8959054],"radius":1.5})
.union(
