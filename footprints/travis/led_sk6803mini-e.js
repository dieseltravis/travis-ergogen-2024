...
//  * 6803 pinout differs from 6812 & 6805
//  * TODO: add the 6803 pinout as an option to 6812?
...
module.exports = {
  params: {
    ...
    valpos: [0, -2.25],
    value: 'SK6803mini-e',
    P3: { type: 'net', value: 'VCC' },     // VDD
    P4: { type: 'net', value: undefined }, // DOUT
    P1: { type: 'net', value: 'GND' },     // GND (cut pin)
    P2: { type: 'net', value: undefined }  // DIN
  },
  body: p => {
    const pos = (arr) => arr.join(' ');
    if (p.refpos.length === 2) {
      p.refpos.push(90 + p.r);
    }
    ...
    const standard_opening = `
      (module "travis:led_SK6803mini-e (${p.reverse_mount ? "per-key" : "underglow"}, ${p.reversible ? "reversible" : "single-side"})" 
        (layer ${p.side}.Cu)
    ...
    const front_reversed = `
        ...
        (fp_line (start -3.8 -1.36) (end -3.56 -1.6) (layer F.SilkS) (width 0.12))
        (pad 4 smd rect (at -2.7 -0.7 ${p.rot}) (size 1.4 1) (layers F.Cu F.Paste F.Mask) ${p.P2.str})
        (pad 3 smd rect (at -2.7 0.7 ${p.rot}) (size 1.4 1) (layers F.Cu F.Paste F.Mask) ${p.P1.str})
        (pad 1 smd rect (at 2.7 -0.7 ${p.rot}) (size 1.4 1) (layers F.Cu F.Paste F.Mask) ${p.P3.str})
        (pad 2 smd rect (at 2.7 0.7 ${p.rot}) (size 1.4 1) (layers F.Cu F.Paste F.Mask) ${p.P4.str})
        `
    const front = `
        (fp_line (start -3.8 -1.6) (end -2.2 -1.6) (layer F.SilkS) (width 0.12))
        (fp_line (start -3.8 0) (end -3.8 -1.6) (layer F.SilkS) (width 0.12))
        (fp_line (start -3.8 -1.36) (end -3.56 -1.6) (layer F.SilkS) (width 0.12))
        (pad 4 smd rect (at -2.70 0.7 ${p.rot}) (size 1.4 1) (layers F.Cu F.Paste F.Mask) ${p.P2.str})
        (pad 3 smd rect (at -2.70 -0.7 ${p.rot}) (size 1.4 1) (layers F.Cu F.Paste F.Mask) ${p.P1.str})
        (pad 1 smd rect (at 2.70 0.7 ${p.rot}) (size 1.4 1) (layers F.Cu F.Paste F.Mask) ${p.P3.str})
        (pad 2 smd rect (at 2.70 -0.7 ${p.rot}) (size 1.4 1) (layers F.Cu F.Paste F.Mask) ${p.P4.str})
    `
    const back_reversed = `
        ...
        (pad 2 smd rect (at 2.70 -0.7 ${p.rot}) (size 1.4 1) (layers B.Cu B.Paste B.Mask) ${p.P4.str})
        (pad 1 smd rect (at 2.70 0.7 ${p.rot}) (size 1.4 1) (layers B.Cu B.Paste B.Mask) ${p.P3.str})
        (pad 3 smd rect (at -2.70 -0.7 ${p.rot}) (size 1.4 1) (layers B.Cu B.Paste B.Mask) ${p.P1.str})
        (pad 4 smd rect (at -2.70 0.7 ${p.rot}) (size 1.4 1) (layers B.Cu B.Paste B.Mask) ${p.P2.str})
      `
    const back = `
        (fp_line (start -3.8 1.6) (end -2.2 1.6) (layer B.SilkS) (width 0.12))
        (fp_line (start -3.8 0) (end -3.8 1.6) (layer B.SilkS) (width 0.12))
    ...
    const traces_vias_reversed = `
      ${'' /* VCC Trace */}
      (segment (start ${adjust_point(3.4, -0.7)}) (end ${adjust_point(4.06, -0.105916)}) (width ${p.vcc_trace_width}) (layer "F.Cu") (net ${p.P3.index}))
      (segment (start ${adjust_point(4.06, -0.105916)}) (end ${adjust_point(4.06, 0.7)}) (width ${p.vcc_trace_width}) (layer "F.Cu") (net ${p.P3.index}))
      (segment (start ${adjust_point(2.7, -0.7)}) (end ${adjust_point(3.4, -0.7)}) (width ${p.vcc_trace_width}) (layer "F.Cu") (net ${p.P3.index}))
      (via (at ${adjust_point(4.06, 0.7)}) (size ${p.via_size}) (drill ${p.via_drill}) (layers "F.Cu" "B.Cu") (net ${p.P3.index}))
      (segment (start ${adjust_point(2.7, 0.7)}) (end ${adjust_point(4.06, 0.7)}) (width ${p.vcc_trace_width}) (layer "B.Cu") (net ${p.P3.index}))
      ...
      ${'' /* GND Trace */}
      (segment (start ${adjust_point(-3.4, -0.7)}) (end ${adjust_point(-4.06, -0.105916)}) (width ${p.gnd_trace_width}) (layer "B.Cu") (net ${p.P1.index}))
      (segment (start ${adjust_point(-4.06, -0.105916)}) (end ${adjust_point(-4.06, 0.7)}) (width ${p.gnd_trace_width}) (layer "B.Cu") (net ${p.P1.index}))
      (segment (start ${adjust_point(-2.7, -0.7)}) (end ${adjust_point(-3.4, -0.7)}) (width ${p.gnd_trace_width}) (layer "B.Cu") (net ${p.P1.index}))
      (via (at ${adjust_point(-4.06, 0.7)}) (size ${p.via_size}) (drill ${p.via_drill}) (layers "F.Cu" "B.Cu") (net ${p.P1.index}))
      (segment (start ${adjust_point(-2.7, 0.7)}) (end ${adjust_point(-4.06, 0.7)}) (width ${p.gnd_trace_width}) (layer "F.Cu") (net ${p.P1.index}))
    ...
    ${'' /* VCC Trace */}
    (segment (start ${adjust_point(3.4, -0.7)}) (end ${adjust_point(4.06, -0.105916)}) (width ${p.vcc_trace_width}) (layer "B.Cu") (net ${p.P3.index}))
    (segment (start ${adjust_point(4.06, -0.105916)}) (end ${adjust_point(4.06, 0.7)}) (width ${p.vcc_trace_width}) (layer "B.Cu") (net ${p.P3.index}))
    (segment (start ${adjust_point(2.7, -0.7)}) (end ${adjust_point(3.4, -0.7)}) (width ${p.vcc_trace_width}) (layer "B.Cu") (net ${p.P3.index}))
    (via (at ${adjust_point(4.06, 0.7)}) (size ${p.via_size}) (drill ${p.via_drill}) (layers "F.Cu" "B.Cu") (net ${p.P3.index}))
    (segment (start ${adjust_point(2.7, 0.7)}) (end ${adjust_point(4.06, 0.7)}) (width ${p.vcc_trace_width}) (layer "F.Cu") (net ${p.P3.index}))
    ${'' /* Data signal out trace */}
    ...
    ${'' /* GND Trace */}
    (segment (start ${adjust_point(-3.4, -0.7)}) (end ${adjust_point(-4.06, -0.105916)}) (width ${p.gnd_trace_width}) (layer "F.Cu") (net ${p.P1.index}))
    (segment (start ${adjust_point(-4.06, -0.105916)}) (end ${adjust_point(-4.06, 0.7)}) (width ${p.gnd_trace_width}) (layer "F.Cu") (net ${p.P1.index}))
    (segment (start ${adjust_point(-2.7, -0.7)}) (end ${adjust_point(-3.4, -0.7)}) (width ${p.gnd_trace_width}) (layer "F.Cu") (net ${p.P1.index}))
    (via (at ${adjust_point(-4.06, 0.7)}) (size ${p.via_size}) (drill ${p.via_drill}) (layers "F.Cu" "B.Cu") (net ${p.P1.index}))
    (segment (start ${adjust_point(-2.7, 0.7)}) (end ${adjust_point(-4.06, 0.7)}) (width ${p.gnd_trace_width}) (layer "B.Cu") (net ${p.P1.index}))
    ${'' /* Data signal in trace */}
